...
export default class StaffDetail extends Component {
  render() {
    //读取携带过来的state数据
    const { s_id, s_name, a_name, education, duty, card_id, in_time, phone, nation, gender, marry, political, area, birth, toregular_time, other } = this.props.location.state.staff
