...
export default class InternshipUpdate extends Component {
  ...
  onFinish = async (values) => {
    ...
    const retire = { s_id, s_name, a_id, education, duty, card_id, in_time, stype, phone, nation, gender, marry, political, area, birth, toregular_time, quit_time, retire_time, other }
    let result = await reqUpdateStaff(retire)
    if (result.data) {
      message.success('更新员工信息成功!')
      window.location.replace('/retire')
    } else {
  ...
  componentWillMount() {
    const retire = this.props.location.state
    this.retire = retire
  }
  render() {
          ...
          <Row>
            <Col span={12}>
              ...
              <Item
                label="入职时间"
                name="intime"
                initialValue={moment(retire.in_time)}
                style={{ fontSize: 30, fontWeight: "bold" }}
            ...
            <Col span={12}>
              ...
              <Item
                label="出生日期"
                name="birthday"
                initialValue={moment(retire.birth)}
                style={{ fontSize: 30, fontWeight: "bold" }}
              ...
              <Item
                label="离职时间"
                name="quittime"
                initialValue={retire.quit_time ? moment(retire.quit_time) : ''}
                style={{ fontSize: 30, fontWeight: "bold" }}
              >
                <DatePicker onChange={this.chooseTime} style={{ width: 450 }} />
              </Item>
              ...
              <Item
                label="转正时间"
                name="toregulartime"
                initialValue={retire.toregular_time ? moment(retire.toregular_time) : ''}
                style={{ fontSize: 30, fontWeight: "bold" }}
              >
                <DatePicker onChange={this.chooseTime} style={{ width: 450 }} />
              </Item>
              ...
              <Item
                label="退休时间"
                name="retiretime"
                initialValue={retire.retire_time ? moment(retire.retire_time) : ''}
                style={{ fontSize: 30, fontWeight: "bold" }}
              >
                <DatePicker onChange={this.chooseTime} style={{ width: 450 }} />
              </Item>
